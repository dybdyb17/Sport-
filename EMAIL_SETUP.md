...
- OVH ou Cloudflare → acheter `sportplus-13.fr`
...
- Resend → Domains → Add Domain → sportplus-13.fr
...
APP_EMAIL_FROM=contact@sportplus-13.fr
...
- L'expéditeur DOIT être `@sportplus-13.fr` (gmail bloqué par DMARC pour envoi auto)
- Les réponses clients arrivent sur `ls.sportplus13@gmail.com` (Reply-To)
- Le client voit : `SPORT+ Marseille <contact@sportplus-13.fr>`
